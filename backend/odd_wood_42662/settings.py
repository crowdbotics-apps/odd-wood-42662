"""
Django settings for odd_wood_42662 project.
...
ROOT_URLCONF = 'odd_wood_42662.urls'
...
WSGI_APPLICATION = 'odd_wood_42662.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_wood_42662 API",
    "DESCRIPTION": "API documentation for odd_wood_42662 App",
    "VERSION": "v1",
}
